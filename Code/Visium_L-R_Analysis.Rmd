...
```{r}
lr_sn = read_csv("Data/L-R snRNA.csv")
lr_spatial = read_csv("Data/L-R spatial.csv")
...
temp2 = liver_celltrek_normal[,liver_celltrek_normal@meta.data$celltype %in% 
                  c('HSC/Fibroblasts','Kupffer Cells')]
SpatialDimPlot(temp2, group.by='celltype', crop=F) + scale_fill_manual(values = c("#8b008b","#ff00ff"))
...
temp2 = liver_celltrek_normal[,liver_celltrek_normal@meta.data$celltype %in% 
                  c('LSEC Zone 2&3 1','LSEC Zone 2&3 2')]
SpatialDimPlot(temp2, group.by='celltype', crop=F) + scale_fill_manual(values = c("#0096FF","#FF7518"))
...
p1=SpatialFeaturePlot(liver_celltrek_ba[,liver_celltrek_ba@assays$SCT@data['FGF23',] > 0], 
                      features = c("FGF23"), crop=F)  + scale_fill_gradientn(colours=cscale)
p2=SpatialFeaturePlot(liver_celltrek_ba[,liver_celltrek_ba@assays$SCT@data['FGFR1',] > 0], 
                      features = c("FGFR1"), crop=F)  + scale_fill_gradientn(colours=cscale)
p1+p2

p1=SpatialFeaturePlot(liver_celltrek_normal[,liver_celltrek_normal@assays$SCT@data['FGF23',] > 0], 
                      features = c("FGF23"), crop=F)  + scale_fill_gradientn(colours=cscale)
p2=SpatialFeaturePlot(liver_celltrek_normal[,liver_celltrek_normal@assays$SCT@data['FGFR1',] > 0], 
                      features = c("FGFR1"), crop=F)  + scale_fill_gradientn(colours=cscale)
p1+p2



p1=SpatialFeaturePlot(liver_celltrek_ba[,liver_celltrek_ba@assays$SCT@data['LAMC3',] > 0], 
                      features = c("LAMC3"), crop=F)  + scale_fill_gradientn(colours=cscale)
p2=SpatialFeaturePlot(liver_celltrek_ba[,liver_celltrek_ba@assays$SCT@data['CD44',] > 0], 
                      features = c("CD44"), crop=F)  + scale_fill_gradientn(colours=cscale)
p1+p2

p1=SpatialFeaturePlot(liver_celltrek_normal[,liver_celltrek_normal@assays$SCT@data['LAMC3',] > 0], 
                      features = c("LAMC3"), crop=F)  + scale_fill_gradientn(colours=cscale)
p2=SpatialFeaturePlot(liver_celltrek_normal[,liver_celltrek_normal@assays$SCT@data['CD44',] > 0], 
                      features = c("CD44"), crop=F)  + scale_fill_gradientn(colours=cscale)
p1+p2
```

...
```{r}
liver_sc_normal = LoadH5Seurat("/users/sarahbangerth/Desktop/Github/sn_normal_labelled.h5seurat")
liver_sc_ba = LoadH5Seurat("/users/sarahbangerth/Desktop/Github/sn_ba_labelled.h5seurat", tools=FALSE)
```
...
## CellTrek
CellTrek is a package to map single-cell data to the spatial spots. This assigns the most likely nucleus to a spatial spot. GitHub: https://github.com/navinlabcode/CellTrek
